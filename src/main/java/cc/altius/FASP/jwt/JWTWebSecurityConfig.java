    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth
                        ...
                        .requestMatchers("/error", "/api/logout", "/actuator/**", "/favicon.ico**", "/actuator**", "/actuator/info", "/browser**", "/file**", "/file/**", "/api/locales/*/**", "/api/forgotPassword/**", "/api/getForgotPasswordToken/**", "/api/confirmForgotPasswordToken/**", "/api/updatePassword/**", "/api/updateExpiredPassword/**", "/exportSupplyPlan/**", "/exportManualJson", "/exportProgramData/**", "/exportOrderData/**", "/importShipmentData/**", "/importProductCatalog/**", "/importProductCatalogLegacy/**", "/api/sync/language/**", "/exportShipmentLinkingData/**", "/jira/syncJiraAccountIds/**", "/api/processCommitRequest/**", "/api/rebuildSupplyPlans").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/country/all").hasAnyAuthority("ROLE_BF_TICKETING", "ROLE_BF_LIST_COUNTRY", "ROLE_BF_ADD_HEALTH_AREA", "ROLE_BF_MAP_REALM_COUNTRY", "ROLE_BF_LIST_REALM")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/dataSource/**").hasAnyAuthority("ROLE_BF_EDIT_DATA_SOURCE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/equivalencyUnit/all").hasAnyAuthority("ROLE_BF_LIST_EQUIVALENCY_UNIT_MAPPING")
                        .requestMatchers(HttpMethod.POST, "/api/equivalencyUnit").hasAnyAuthority("ROLE_BF_LIST_EQUIVALENCY_UNIT_MAPPING")
                        .requestMatchers(HttpMethod.POST, "/api/forecastingUnit/byIds").hasAnyAuthority("ROLE_BF_LIST_USAGE_TEMPLATE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/role").hasAnyAuthority("ROLE_BF_TICKETING", "ROLE_BF_ADD_ROLE", "ROLE_BF_EDIT_ROLE", "ROLE_BF_LIST_ROLE", "ROLE_BF_ADD_USER", "ROLE_BF_EDIT_USER", "ROLE_BF_LIST_USER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/programData/getLatestVersionForPrograms", "/api/user/module/**", "/api/user/agreement", "/api/programData/checkNewerVersions", "/api/changePassword").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/user/**", "/api/procurementAgent", "/api/erpLinking/getNotificationCount").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/unit/**").hasAnyAuthority("ROLE_BF_EDIT_UNIT")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/tracerCategory/realmId/**").hasAnyAuthority("ROLE_BF_FORECAST_MATRIX_REPORT")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/report/stockStatusVertical/dropdowns").hasAnyAuthority("ROLE_BF_SUPPLY_PLAN_REPORT")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/report/updateProgramInfo/programTypeId/**").hasAnyAuthority("ROLE_BF_LIST_PROGRAM", "ROLE_BF_LIST_DATASET", "ROLE_BF_LIST_ALTERNATE_REPORTING_UNIT")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/realmCountry").hasAnyAuthority("ROLE_BF_MAP_REGION")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/region", "/api/region/**").hasAnyAuthority("ROLE_BF_TICKETING")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/fundingSourceType").hasAnyAuthority("ROLE_BF_EDIT_FUNDING_SOURCE")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/pipelineJson/**", "/api/qatTemp/program/**", "/api/pipeline/shipment/**", "/api/pipeline/programdata/**").hasAnyAuthority("ROLE_BF_PIPELINE_PROGRAM_IMPORT")
                        .requestMatchers(HttpMethod.GET, "/api/pipeline/**", "/api/pipeline/programInfo/**", "/api/qatTemp/program/**", "/api/pipeline/shipment/**", "/api/qatTemp/planningUnitList/**", "/api/qatTemp/regions/**", "/api/pipeline/consumption/**", "/api/qatTemp/consumption/**", "/api/pipeline/inventory/**", "/api/qatTemp/planningUnitListFinalInventry/**", "/api/qatTemp/datasource/**", "/api/qatTemp/fundingsource/**", "/api/qatTemp/procurementagent/**").hasAnyAuthority("ROLE_BF_PIPELINE_PROGRAM_IMPORT")
                        .requestMatchers(HttpMethod.PUT, "/api/pipeline/planningUnit/**", "/api/pipeline/consumption/**", "/api/pipeline/inventory/**", "/api/pipeline/datasource/**", "/api/pipeline/fundingsource/**", "/api/pipeline/procurementagent/**", "/api/pipeline/realmCountryPlanningUnit/**").hasAnyAuthority("ROLE_BF_PIPELINE_PROGRAM_IMPORT")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/language").hasAnyAuthority("ROLE_BF_ADD_COUNTRY", "ROLE_BF_EDIT_COUNTRY", "ROLE_BF_LABEL_TRANSLATIONS", "ROLE_BF_ADD_USER", "ROLE_BF_EDIT_USER", "ROLE_BF_LIST_USER", "ROLE_BF_EDIT_LANGUAGE", "ROLE_BF_TICKETING")
                        ...
                        .requestMatchers("/api/programData/shipmentSync/programId/**", "/api/sync/allMasters/forPrograms/**", "/api/erpLinking/shipmentSync", "/api/getCommitRequest/**").authenticated()
